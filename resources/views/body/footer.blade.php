    ...
    <div id="footer">
        <div class="container">
            <div class="row copy-right">
                ...
                <!-- Social -->
                <p class="social-icon">
                    <a href="https://www..com/in/king-obioma-53a266382" target="_blank"><i class="fab fa-linkedin"></i></a>
                    <a href="https://www.instagram.com/iamobiomaking" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a href="https://www.facebook.com/iamobiomaking" target="_blank"><i class="fab fa-facebook"></i></a>
